package cn.iosd.starter.socketio.service;
 ...
 */
@Service
public class SocketIOMessageServer {
    private static final Logger log = LoggerFactory.getLogger(SocketIOMessageServer.class);
