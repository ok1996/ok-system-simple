package cn.iosd.base.generator.api.project.service;

import cn.iosd.base.generator.api.project.vo.ProjectGenVo;
...
public class ProjectGenService {
     ...
     * 初始化压缩包地址
     */
    @Value("${simple.generator.project.initProjectZipUrl:/temp/initProject.zip}")
    private String initProjectZipUrl;

    /**
     * 解压覆盖生成项目压缩包操作的临时目录
     */
    @Value("${simple.generator.project.newProjectAndZipTempPath:/temp/simple/new}")
